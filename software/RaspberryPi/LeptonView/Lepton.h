...
extern uint16_t Lepton_Frame[FRAME_HEIGHT][FRAME_WIDTH]; // 16비트 -> 픽셀 하나당 2바이트
...
void Normalize(uint16_t Lepton_Frame[FRAME_HEIGHT][FRAME_WIDTH], uint8_t Normalized_Frame[FRAME_HEIGHT][FRAME_WIDTH][3]);
